...
using TomiSoft.YoutubeDownloader.BackgroundDownloaderService.Models;
using TomiSoft.YouTubeDownloader.BackgroundDownloaderService.HostedServices;

namespace TomiSoft.YoutubeDownloader.BackgroundDownloaderService.Controllers {
    public class DownloaderController : Controller
    {
        ...
        public IActionResult EnqueueDownload([FromQuery] string MediaUri, [FromQuery] string MediaFormat) {
            MediaFormat TargetFormat = Media.MediaFormat.Video;

            if (MediaFormat == "mp3audio") {
                TargetFormat = Media.MediaFormat.MP3Audio;
            }
